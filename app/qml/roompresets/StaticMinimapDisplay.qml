...
Item {
  ...
  VectorImage {
    anchors.fill: parent
    source: presetModel && presetModel.areaCode ? 'qrc:/labcompass/assets/images/room-preset/' + presetModel.areaCode + '.svg' : ''
    width: 16
    height: 16
  }
  ...
  Repeater {
    ...
    VectorImage {
      ...
      source: 'qrc:/labcompass/assets/images/compass/door-target.svg'
    }
  }
  ...
  Repeater {
    ...
    VectorImage {
      ...
      width: modelData.tileRect.width * root.width
      height: modelData.tileRect.height * root.height
      source: 'qrc:/labcompass/assets/images/compass/loot-normal.svg'
    }
  }
}
