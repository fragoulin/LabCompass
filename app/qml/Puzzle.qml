      ...
      Repeater {
        ...
        Item {
          ...
          Rectangle {
            ...
            state: root.switchModel & (1 << index) ? 'active' : 'inactive'
            states: [
          ...
          Item {
            ...
            Repeater {
              ...
              Item {
                ...
                VectorImage {
                  anchors.centerIn: guideFocusItem
                  rotation: index * 90
                  source: 'qrc:/qt/qml/labcompass/assets/images/rounded-corner.svg'
                  width: 16
                  height: 16
                }
              }
            }
            state: root.guideModel & (1 << index) ? 'active' : 'inactive'
            states: [
          ...
          MouseArea {
            ...
            onClicked: {
              root.switchModel = root.switchModel ^ (1 << index);
              root.guideModel = 0;
            }
          }
        }
